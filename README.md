...
**🌊 Underwater Image Processing for Detection of Polymetallic Nodules**
ML + Deep Learning pipeline to enhance underwater images and detect deep-sea polymetallic nodules.
Tech: Python • OpenCV • TensorFlow • YOLOv5 • Scikit-learn

🔗 https://github.com/rakeshkumar04/Underwater-Image-Processing-for-Detection-of-Polymetallic-Nodules

**🛒 Cart App — E-Commerce Backend API**
Spring Boot backend with product catalog, orders, reviews, filtering, and pagination.
